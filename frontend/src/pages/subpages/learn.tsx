          ...
          <div className="flex flex-col space-y-4">
            <div className="flex flex-col space-y-2">
              <label htmlFor="inputText" className="font-semibold text-lg">
                Write up a question such as: "How do I ask for directions in
                Spanish?"
              </label>
              <textarea
                id="inputText"
                className="border rounded-lg p-4 h-32 resize-none outline-none"
                value={inputText}
            ...
            <div className="flex justify-end">
              <button
                className="bg-green-500 hover:bg-green-600 text-white py-1 px-2 md:px-3 rounded-lg w-fit text-xl self-end"
                onClick={saveHighlightedWords}
              >
                Add to Vocabulary
              </button>
              <button
                className="bg-blue-500 hover:bg-blue-600 text-white py-1 px-2 md:px-3 rounded-lg w-fit text-xl self-end ml-4"
