...
const Sidebar = () => {
  ...
  return (
    <div
      className="sidebar p-4 flex flex-col justify-between fixed left-0 top-0 bottom-0 bg-blue-200"
    ...
    >
      <div>
        ...
        <div className="menu">
          ...
          <Link
            to="/learn"
            className={`menu-item ${selectedItem === "learn" ? "active" : ""}`}
            onClick={() => handleItemClick("learn")}
          >
            <div className="flex items-center py-2 px-3 rounded-lg hover:bg-blue-600">
              <FaComments className="mr-2" /> Learn
            </div>
          </Link>
          <Link
            to="/lessons"
            className={`menu-item ${
              selectedItem === "lessons" ? "active" : ""
            }`}
          ...
          <Link
            to="/vocabulary"
            className={`menu-item ${
              selectedItem === "vocabulary" ? "active" : ""
            }`}
      ...
      <div className="flex justify-between">
        <Link
          to="/faq"
          className="flex items-center py-2 px-3 rounded-lg hover:bg-blue-600"
        >
          FAQ
        </Link>
        <Link
